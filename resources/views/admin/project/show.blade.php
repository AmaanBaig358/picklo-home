                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="project-title" class="form-control"
                                                   placeholder="Enter Project Title" required value="{{$project->client->lead->client_name}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Enter Project Title" required value="{{$project->client->lead->client_email}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Enter Project Title" required value="{{$project->client->lead->client_phone}}" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                           placeholder="Enter Project Title" disabled value="{{$project->name}}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="date" class="form-control"
                                               disabled value="{{$project->start_date}}">
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="file" id="fileInput1" disabled multiple
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="file" id="fileInput2" disabled multiple
                                               style="display: none;" accept="image/*, .pdf, .docx">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <ul>
                                        @foreach($project->members as $user)
                                            <li class="text-info label-danger">{{ $user->user->name }}</li>
                                        @endforeach
                                    </ul>
                                </div>
