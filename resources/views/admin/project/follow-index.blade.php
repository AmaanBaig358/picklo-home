            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Project Follow-Ups</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="d-flex w-100">
                        ...
                        <div class="w-50">
                            <a href="{{ route('admin.create.project.followup', $project->faker_id) }}" class="float-end btn btn-success btn-sm ms-3">Add New</a>
                        </div>
                    </div>
                                            ...
                                            <table id="basic-datatable" class="datatable table table-striped dt-responsive nowrap w-100">
                                                ...
                                                @foreach($upcomingFollowUps as $followUp)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.edit.followup', $followUp->faker_id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="{{ route('admin.complete.followup', $followUp->faker_id) }}" class="btn btn-sm btn-success">Mark Complete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            ...
                                            <table id="basic-datatable" class="datatable table table-striped dt-responsive nowrap w-100">
                                                ...
                                                @foreach($todayFollowUps as $followUp)
                                                    <tr>
                                                        ...
                                                        <td>{{ $followUp->description }}</td>
                                                        <td>{{ $followUp->reminder_date }}</td>
                                                        <td><span class="text-info text-uppercase">{{ $followUp->status }}</span></td>
                                                        <td>
                                                            <a href="{{ route('admin.edit.followup', $followUp->faker_id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="{{ route('admin.complete.followup', $followUp->faker_id) }}" class="btn btn-sm btn-success">Mark Complete</a>
                                                        </td>
